...
| File | Rows | Contents |
|---|---:|---|
| `unified_corpus.csv` | 716 | One row per screened-in posting: platform, job id, archived URL, capture date, title, employer, raw and parsed location, region, multi-location flag, `evidence_level`, screening decision, matched terms, language and market signals |
...
recoverable `primary_country`. The remaining 500 postings support claims about
